...
DEFAULT_SETTINGS: dict[str, str] = {
    ...
    "vat_enabled": "1",
    "vat_rate_pct": "20",
    "supplier_markup_pct": "0",
    "comfort_fit_adjust_mm": "0",
...
def get_all_settings(conn: sqlite3.Connection) -> dict[str, Any]:
    ...
    return {
        ...
        "supplier_markup_pct": get_float("supplier_markup_pct"),
        "comfort_fit_adjust_mm": get_float("comfort_fit_adjust_mm"),
...
def save_settings(conn: sqlite3.Connection, settings: dict[str, Any]) -> None:
    ...
    payload = {
        ...
        "supplier_markup_pct": str(settings["supplier_markup_pct"]),
        "comfort_fit_adjust_mm": str(settings["comfort_fit_adjust_mm"]),
